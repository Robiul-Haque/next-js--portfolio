  ...
  return (
    <section className="flex flex-col flex-grow px-6 pt-1">
      <h6 className="my-3 text-base font-medium">
        Hi, I have 1+ years of experience in Web Development. I am currently studying degree (First year).
      </h6>
      <div
        className="flex-grow p-5 mt-5 bg-gray-200 rounded-b-xl dark:bg-black"
      ...
      >
        ...
        <motion.div
          className="grid gap-8 my-8 md:grid-cols-2"
          variants={stagger}
          initial="initial"
          animate="animate"
          exit="exit"
        >
          <motion.div
            className="flex items-center p-4 space-x-4 bg-white rounded-lg dark:bg-[#16181d]"
            variants={fadeInUp}
          >
